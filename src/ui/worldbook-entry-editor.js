...
export function openWorkbenchEntryEditor({parent, entry, title, onSave}) {
  ...
  for(const [value,text] of [['0','角色定义前'],['1','角色定义后'],['2','作者注释前'],['3','作者注释后'],['4:0','[系统] 插入深度 @D'],['4:1','[用户] 插入深度 @D'],['4:2','[助手] 插入深度 @D'],['5','示例消息前'],['6','示例消息后'],['7','出口']]){const option=node('option','',text);option.value=value;positionInput.append(option);}
