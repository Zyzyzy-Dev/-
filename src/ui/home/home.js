...
const notesCat = new URL('../assets/kitten-notes.webp', import.meta.url).href;
const boxCat = new URL('../assets/kitten-box.webp', import.meta.url).href;
const comingSoon = new URL('../assets/kitten-coming-soon.webp', import.meta.url).href;
